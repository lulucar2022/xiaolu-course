            ...
            <div class="login-box">
                ...
                <div class="login-left">
                    <a href="/" title="小鹿线" class="logo">
                        <img src="../assets/imgs/logo.png" alt="小鹿线" title="小鹿线">
                    </a>
                    <div class="left-qrcode">
                        <div id="qrcode" title="小鹿线"><canvas width="180" height="180" style="display: none;"></canvas><img
                                src="" style="display: block;"></div>
                ...
                <div class="login-right">
                    <div class="login-form">
                        <ul class="nav nav-tabs">
                            <li v-for='item in loginTxt' :key='item.id' class="nav-items"
                                :class='current == item.id ? "actives" : ""' @click='loginChange(item.id)'>
                                <a :class='current == item.id ? "actives" : ""'>{{ item.text }}</a>
                            </li>
                        </ul>
                                ...
                                <div class="tab-main">
                                    <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules">
                                        ...
                                        <div class="login-text">
                                            登录即同意相关服务条款和隐私政策 <a>《用户服务协议》</a><a>《隐私政策》</a> 若您没有账号，系统将为您自动创建账号并登录。
                                        </div>
                                    </el-form>
                                </div>
                            </div>
                                    ...
                                    <el-form ref="ruleFormRefPhone" :model="ruleFormPhone" :rules="rulesPhone">
                                        ...
                                        <el-form-item class="login-Verification" prop="captcha">
                                            ...
                                            <el-button @click="sendCode" class="btn btn-primary sendcaptcha"
                                                type="primary">发送验证码</el-button>
                                        </el-form-item>
                                        <div class="login-submit">
                                            <el-button @click="phoneBtn" class="btn btn-primary sendcaptcha"
...
let rulesPhone = reactive({
    phone: [
        ...
        { pattern: /^1[3456789]\d{9}$/, message: '请输入正确的中国大陆手机号' },
    ],
    captcha: [
